...
#define PORT GPIOA
#define _DIO GPIO_PIN_0
#define _CLK GPIO_PIN_1
#define HIGH 1
#define LOW 0
...
void start(void)
{
  HAL_GPIO_WritePin(PORT, _CLK, HIGH);
  HAL_GPIO_WritePin(PORT, _DIO, HIGH);
  HAL_Delay(1/200);
  HAL_GPIO_WritePin(PORT, _DIO, LOW);
  HAL_GPIO_WritePin(PORT, _CLK, LOW);
  HAL_Delay(1/200);
}
